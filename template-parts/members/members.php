<?php
$page_one 	= get_theme_mod( 'members_page_one', '' );
$page_two 	= get_theme_mod( 'members_page_two', '' );
$page_three = get_theme_mod( 'members_page_three', '' );
$page_four  = get_theme_mod( 'members_page_four', '' ); 
...
if( !get_theme_mod( 'disable_members_section', true ) && $has_page ){ ?>
	<section class="section-member-area">
		<div class="content-wrap">
			<div class="row">
				<?php foreach( $page_array as $each_page ){ ?>
					<div class="col-md-6 col-lg-3">
						<article class="member-content-wrap">
							...
							<div class="member-content">
								...
								<div class="button-container">
									<a href="<?php echo esc_url( get_permalink( $each_page[ 'ID' ] ) ); ?>" class="button-text">
										<?php echo esc_html__( 'Continue reading', 'bosa-ev-charging-station' ); ?>
