...
function bosa_ev_charging_station_default_styles(){
	...
	if( !get_theme_mod( 'disable_header_button', false ) ){
		if( get_theme_mod( 'header_layout', 'header_thirteen' ) == 'header_thirteen' ){
	...
	# Header Image / Slider
	#Header Image Height
	$header_image_height = get_theme_mod( 'header_image_height', 170 );
	$css .= '
	...
	if( get_theme_mod( 'footer_layout', 'footer_three' ) == 'footer_one' || get_theme_mod( 'footer_layout', 'footer_three' ) == 'footer_two' || get_theme_mod( 'footer_layout', 'footer_three' ) == 'footer_eight' ){
	...
	if( get_theme_mod( 'disable_mobile_advertisement', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
	...
	# Responsive Members
	if( get_theme_mod( 'disable_mobile_members', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
				.section-member-area {
	    			display: none;
	...
	if( get_theme_mod( 'disable_mobile_highlights', false ) ){
		$css .= '
			@media screen and (max-width: 767px){
...
add_action( 'wp_head', 'bosa_ev_charging_station_default_styles', 99 );