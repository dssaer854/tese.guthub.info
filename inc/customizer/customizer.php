 ...
 */
add_action( 'customize_preview_init', 'bosa_ev_charging_station_customize_preview_js', 999, 1 );

function bosa_ev_charging_station_customize_preview_js() {
	wp_enqueue_script( 'bosa-ev-charging-station-customizer', get_stylesheet_directory_uri() . '/inc/customizer/customizer.js', array( 'customize-preview' ) );
}

function bosa_ev_charging_station_customize_getting_js() {
	wp_dequeue_script( 'bosa-customizer-getting-started' );
	wp_enqueue_script( 'bosa-ev-charging-station-customizer-getting-started', get_stylesheet_directory_uri() . '/inc/getting-started/getting-started.js', array( 'customize-controls', 'jquery' ), true );

	wp_enqueue_style( 'bosa-ev-charging-station-customize-controls', get_stylesheet_directory_uri() . '/inc/customizer/customizer.css' );
}
add_action( 'customize_controls_enqueue_scripts', 'bosa_ev_charging_station_customize_getting_js', 99 );
 ...
 * @return void
 */
add_action( 'init' , 'bosa_ev_charging_station_kirki_fields', 999, 1 );

function bosa_ev_charging_station_kirki_fields(){
	...
	*/
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Title', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Site Description', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Menu', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Main Menu Description', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Body', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'General Title (H1 - H6)', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page & Single Post Title', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Title Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Meta Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Excerpt Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Slider Button Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Content Alignment', 'bosa-ev-charging-station' ),
		'type'        => 'select',
		'settings'    => 'main_slider_content_alignment',
		'section'     => 'main_slider_options',
		'default'     => 'left',
		'choices'  => array(
			'center' => esc_html__( 'Center', 'bosa-ev-charging-station' ),
			'left'   => esc_html__( 'Left', 'bosa-ev-charging-station' ),
			'right'  => esc_html__( 'Right', 'bosa-ev-charging-station' ),
		),
		'priority'	  =>  180,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Title Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Section Description Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Excerpt Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Widget Title Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Layouts', 'bosa-ev-charging-station' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-ev-charging-station' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Top Header Section', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement Text Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement Banner', 'bosa-ev-charging-station' ),
		'description'  => esc_html__( 'Image dimensions 555 by 68 pixels is recommended.', 'bosa-ev-charging-station' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-ev-charging-station' ),
		'type'        => 'select',
		'settings'    => 'render_header_ad_image_size',
		'section'     => 'header_style_options',
		'default'     => 'full',
		'placeholder' => esc_html__( 'Select Image Size', 'bosa-ev-charging-station' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Advertisement Banner Link', 'bosa-ev-charging-station' ),
		'type'     => 'link',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Non Transparent Mid Header Background Color', 'bosa-ev-charging-station' ),
		'description'  => esc_html__( 'It can be used as a transparent background color over image.', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Non Transparent Mid Header Text Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Cart Count Background Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Cart Count Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Non Transparent Mid Header Text Link Hover Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Mid Header Section Border', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Category Menu', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Menu Background Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Category Menu Text Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Header Hamburger Icon Background Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Header Hamburger Icon Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Header Height (in px)', 'bosa-ev-charging-station' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Advertisement Text', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Advertisement Text', 'bosa-ev-charging-station' ),
		'type'     => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement Text Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'header_style_options',
	    'default'     => esc_html__( 'Contact Details Options', 'bosa-ev-charging-station' ),
	    'priority'	   => 317,
	    'active_callback' => array(
			array(
				'setting'  => 'header_layout',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Contact Details', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
		...
		'active_callback' => array(
			array(
				'setting'  => 'header_layout',
				'operator' => 'contains',
				'value'    => array( 'header_one', 'header_two', 'header_fifteen', 'header_thirteen' ),
			),
		),
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Contact Detail Icon color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Phone Label', 'bosa-ev-charging-station' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Phone Number', 'bosa-ev-charging-station' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Email Label', 'bosa-ev-charging-station' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
			'label'        => esc_html__( 'Email', 'bosa-ev-charging-station' ),
			'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Address Label', 'bosa-ev-charging-station' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Address', 'bosa-ev-charging-station' ),
		'type'         => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Contact Label Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Contact Content Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'header_style_options',
	    'default'     => esc_html__( 'Header Button Options', 'bosa-ev-charging-station' ),
	    'priority'	  => 354,
	    'active_callback' => array(
			array(
				'setting'  => 'header_layout',
	...
	// Header button
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Header Buttons', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Header Buttons', 'bosa-ev-charging-station' ),
		'type'         => 'repeater',
		'settings'     => 'header_button_repeater',
		'section'      => 'header_style_options',
		'row_label' => array(
			'type'  => 'text',
			'value' => esc_html__( 'Button', 'bosa-ev-charging-station' ),
		),
		'default' => array(
			array(
		...
		'fields' => array(
			'header_btn_type' => array(
				'label'       => esc_html__( 'Button Type', 'bosa-ev-charging-station' ),
				'type'        => 'select',
				'default'     => 'button-outline',
				'choices'  	  => array(
					'button-primary' => esc_html__( 'Background Button', 'bosa-ev-charging-station' ),
					'button-outline' => esc_html__( 'Border Button', 'bosa-ev-charging-station' ),
					'button-text'    => esc_html__( 'Text Only Button', 'bosa-ev-charging-station' ),
				),
			),
			'header_btn_bg_color' 	=> array(
				'label'       		=> esc_html__( 'Non Transparent Header Button Background Color', 'bosa-ev-charging-station' ),
				'description' 		=> esc_html__( 'For background button type only.', 'bosa-ev-charging-station' ),
				'type'        		=> 'color',
				'default'     		=> '#EB5A3E',
			),
			'header_btn_border_color' 	=> array(
				'label'      	 		=> esc_html__( 'Non Transparent Header Button Border Color', 'bosa-ev-charging-station' ),
				'description' 			=> esc_html__( 'For border button type only.', 'bosa-ev-charging-station' ),
				'type'       		 	=> 'color',
				'default'     			=> '#1a1a1a',
			),
			'header_btn_text_color' => array(
				'label'       		=> esc_html__( 'Non Transparent Header Button Text Color', 'bosa-ev-charging-station' ),
				'type'        		=> 'color',
				'default'     		=> '#1a1a1a',
			),
			'header_btn_hover_color' => array(
				'label'       		=> esc_html__( 'Non Transparent Header Button Hover Color', 'bosa-ev-charging-station' ),
				'type'        		=> 'color',
				'default'     		=> '#086abd',
			),
			'header_btn_text' => array(
				'label'       => esc_html__( 'Button Text', 'bosa-ev-charging-station' ),
				'type'        => 'text',
				'default' 	  => '',
			),
			'header_btn_link' => array(
				'label'       => esc_html__( 'Button Link', 'bosa-ev-charging-station' ),
				'type'        => 'text',
				'default' 	  => '',
			),
			'header_btn_target' => array(
				'label'       	=> esc_html__( 'Open Link in New Window', 'bosa-ev-charging-station' ),	
				'type'        	=> 'checkbox',
				'default'	  	=> true,
			),
			'header_btn_radius' => array(
				'label'       	=> esc_html__( 'Button Radius (px)', 'bosa-ev-charging-station' ),
				'type'        	=> 'number',
				'default'	  	=> 0,
				'choices'     	=> array(
					'min'  => 0,
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Header Buttons Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable WooCommerce Compare', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Disable WooCommerce Wishlist', 'bosa-ev-charging-station' ),
		'type'     => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Disable WooCommerce My Account', 'bosa-ev-charging-station' ),
		'type'     => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Disable WooCommerce Cart', 'bosa-ev-charging-station' ),
		'type'     => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		...
		'active_callback' => array(
			array(
				'setting'  => 'header_layout',
				'operator' => 'contains',
				'value'    => array( 'header_one', 'header_three', 'header_fifteen', 'header_thirteen' ),
			),
		),
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Header Advertisement Banner', 'bosa-ev-charging-station' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Header Secondary Menu', 'bosa-ev-charging-station' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Header Contact Details', 'bosa-ev-charging-station' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Footer Layouts', 'bosa-ev-charging-station' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Bottom Footer Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Select Image', 'bosa-ev-charging-station' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Image Link', 'bosa-ev-charging-station' ),
		'type'     => 'link',
	...
	Kirki::add_field( 'bosa', array(
		'label'    => esc_html__( 'Image Target', 'bosa-ev-charging-station' ),
		'description' => esc_html__( 'If enabled, the page will be open in an another browser tab.', 'bosa-ev-charging-station' ),
		'type'     => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Width', 'bosa-ev-charging-station' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Border', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'feature_posts_options', array(
	    'title'          => esc_html__( 'Featured Posts / Pages', 'bosa-ev-charging-station' ),
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Posts / Pages', 'bosa-ev-charging-station' ),
		...
		'priority'    => '9',
		'choices'  => array(
			'featured_posts' => esc_html__( 'Featured Posts', 'bosa-ev-charging-station' ),
			'featured_pages' => esc_html__( 'Featured Pages', 'bosa-ev-charging-station' ),
		)
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Section', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Title', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Title', 'bosa-ev-charging-station' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Section Description', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Description', 'bosa-ev-charging-station' ),
		'type'        => 'text',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Title and Description Alignment', 'bosa-ev-charging-station' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Section Layout', 'bosa-ev-charging-station' ),
		'description' => esc_html__( 'Select layout & scroll below to change its options', 'bosa-ev-charging-station' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Title Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Background Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Category Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Text Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Meta Icon Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post Hover Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Columns', 'bosa-ev-charging-station' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_columns',
		'section'     => 'feature_posts_options',
		'default'     => 'three_columns',
		'placeholder' => esc_attr__( 'Select category', 'bosa-ev-charging-station' ),
		'choices'  => array(
			'one_column'    => esc_html__( '1 Column', 'bosa-ev-charging-station' ),
			'two_columns'   => esc_html__( '2 Columns', 'bosa-ev-charging-station' ),
			'three_columns' => esc_html__( '3 Columns', 'bosa-ev-charging-station' ),
			'four_columns'  => esc_html__( '4 Columns', 'bosa-ev-charging-station' ),
		),
		'priority'	  =>  160,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Category', 'bosa-ev-charging-station' ),
		'description' => esc_html__( 'Recent posts will show if any category is not chosen.', 'bosa-ev-charging-station' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_category',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select category', 'bosa-ev-charging-station' ), 
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Posts Overlay Opacity', 'bosa-ev-charging-station' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Post View Number', 'bosa-ev-charging-station' ),
		'description'  => esc_html__( 'Number of posts to show.', 'bosa-ev-charging-station' ),
		'type'         => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Height (in px)', 'bosa-ev-charging-station' ),
		'description'  => esc_html__( 'This option will only apply to Desktop. Please click on below Desktop Icon to see changes. Automatically adjust by theme default in the responsive devices.
		', 'bosa-ev-charging-station' ),
		'type'         => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Background Image Size', 'bosa-ev-charging-station' ),
		'type'         => 'radio',
		'settings'     => 'feature_posts_image_size',
		'section'      => 'feature_posts_options',
		'default'      => 'cover',
		'choices'      => array(
			'cover'    => esc_html__( 'Cover', 'bosa-ev-charging-station' ),
			'pattern'  => esc_html__( 'Pattern / Repeat', 'bosa-ev-charging-station' ),
			'norepeat' => esc_html__( 'No Repeat', 'bosa-ev-charging-station' ),
		),
		'priority'	   =>  220,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Posts Border Radius (px)', 'bosa-ev-charging-station' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Text Alignment', 'bosa-ev-charging-station' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_text_alignment',
		'section'     => 'feature_posts_options',
		'default'     => 'text-left',
		'choices'     => array(
			'text-left'	 	=> esc_html__( 'Left', 'bosa-ev-charging-station' ),
			'text-center'  	=> esc_html__( 'Center', 'bosa-ev-charging-station' ),   
			'text-right'	=> esc_html__( 'Right', 'bosa-ev-charging-station' ),
		),
		'priority'	  =>  240,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Alignment', 'bosa-ev-charging-station' ),
		'type'        => 'select',
		'settings'    => 'feature_posts_title_alignment',
		'section'     => 'feature_posts_options',
		'default'     => 'align-bottom',
		'choices'     => array(
			'align-top'	 	=> esc_html__( 'Top', 'bosa-ev-charging-station' ),
			'align-center'  => esc_html__( 'Center', 'bosa-ev-charging-station' ),   
			'align-bottom'  => esc_html__( 'Bottom', 'bosa-ev-charging-station' ),
		),
		'priority'	  =>  250,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Title', 'bosa-ev-charging-station' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Title Divider', 'bosa-ev-charging-station' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Posts category', 'bosa-ev-charging-station' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Date', 'bosa-ev-charging-station' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Author', 'bosa-ev-charging-station' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Post Comment', 'bosa-ev-charging-station' ),
		'type'        => 'checkbox',
	...
	// featured pages
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Pages Section', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 1', 'bosa-ev-charging-station' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_one',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 1', 'bosa-ev-charging-station' ),
		'choices'     => bosa_ev_charging_station_get_pages(),
		'priority'	  => 450,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 2', 'bosa-ev-charging-station' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_two',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'placeholder' => esc_html__( 'Select Page 2', 'bosa-ev-charging-station' ),
		'choices'     => bosa_ev_charging_station_get_pages(),
		'priority'	  => 460,
		'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 3', 'bosa-ev-charging-station' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_three',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'choices'     => bosa_ev_charging_station_get_pages(),
		'placeholder' => esc_html__( 'Select Page 3', 'bosa-ev-charging-station' ),
		'priority'	  => 470,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page 4', 'bosa-ev-charging-station' ),
		'type'        => 'select',
		'settings'    => 'featured_pages_four',
		'section'     => 'feature_posts_options',
		'default'     => '',
		'choices'     => bosa_ev_charging_station_get_pages(),
		'placeholder' => esc_html__( 'Select Page 4', 'bosa-ev-charging-station' ),
		'priority'	  => 480,
		'active_callback' => array(
			array(
				'setting'  => 'feature_posts_pages_tab',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Featured Page Overlay Opacity', 'bosa-ev-charging-station' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Border Radius (px)', 'bosa-ev-charging-station' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Disable Page Title', 'bosa-ev-charging-station' ),
		'type'        => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Title Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Hover Color', 'bosa-ev-charging-station' ),
		'type'         => 'color',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Title Horizontal Alignment', 'bosa-ev-charging-station' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Page Title Vertical Alignment', 'bosa-ev-charging-station' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Page Title Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts / Pages', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_advert_banner_options', array(
	    'title'          => esc_html__( 'Blog Advertisement Banner', 'bosa-ev-charging-station' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => '22',
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement Banner', 'bosa-ev-charging-station' ),
		'description'  => esc_html__( 'Image dimensions 1230 by 100 pixels is recommended.', 'bosa-ev-charging-station' ),
		'type'         => 'image',
	...
	Kirki::add_field( 'bosa', array(
		'label'    		=> esc_html__( 'Advertisement Banner Target', 'bosa-ev-charging-station' ),
		'description' 	=> esc_html__( 'If enabled, the page will be open in an another browser tab.', 'bosa-ev-charging-station' ),
		'type'     		=> 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Advertisement Banner', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'feature_posts_two_options', array(
	    'title'          => esc_html__( 'Featured Posts Two', 'bosa-ev-charging-station' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 24,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Two Section', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Posts Overlay Opacity', 'bosa-ev-charging-station' ),
		'type'        => 'number',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Horizontal Alignment', 'bosa-ev-charging-station' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Content Vertical Alignment', 'bosa-ev-charging-station' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Featured Posts Two', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Layouts', 'bosa-ev-charging-station' ),
		'description' => esc_html__( 'Grid / List / Single/ Grid Thumbnail', 'bosa-ev-charging-station' ),
		'type'        => 'radio-image',
	...
	Kirki::add_field( 'bosa', array(
	    ...
	    'section'     => 'blog_page_style_options',
	    'default'     => esc_html__( 'Thumbnail Post Options', 'bosa-ev-charging-station' ),
	    'priority'	  => 300,
	    'active_callback' => array(
			array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Choose Image Size', 'bosa-ev-charging-station' ),
		'description' => esc_html__( 'Image Size for thumbnail post only.', 'bosa-ev-charging-station' ),
		'type'        => 'select',
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Post Border Radius (px)', 'bosa-ev-charging-station' ),
		'description' => esc_html__( 'Post Border Radius for thumbnail post only.', 'bosa-ev-charging-station' ),
		'type'        => 'slider',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Date', 'bosa-ev-charging-station' ),
		'description'  => esc_html__( 'Disables date for thumbnail post only.', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Author', 'bosa-ev-charging-station' ),
		'description'  => esc_html__( 'Disables author for thumbnail post only.', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Comment Link', 'bosa-ev-charging-station' ),
		'description'  => esc_html__( 'Disables comment link for thumbnail post only.', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Excerpt', 'bosa-ev-charging-station' ),
		'description'  => esc_html__( 'Disables excerpt for thumbnail post only.', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Post Button', 'bosa-ev-charging-station' ),
		'description'  => esc_html__( 'Disables button for thumbnail post only.', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_section( 'blog_services', array(
	    'title'          => esc_html__( 'Services', 'bosa-ev-charging-station' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 26,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Services Section', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Services', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
	...
	// Highlights
	Kirki::add_section( 'blog_highlights', array(
	    'title'          => esc_html__( ' Highlights', 'bosa-ev-charging-station' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 27,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable  Highlights Section', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_highlights_section',
		'section'      => 'blog_highlights',
		'default'      => true,
		'priority'	   => 10,
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image One', 'bosa-ev-charging-station' ),
		'type'         => 'image',
		'settings'     => 'blog_highlights_one',
		'section'      => 'blog_highlights',
		'default'      => '',
		'priority'	   => '20',
		'choices'     => array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Caption One', 'bosa-ev-charging-station' ),
		'type'        => 'text',
		'settings'    => 'highlights_caption_one',
		'section'     => 'blog_highlights',
		'default'     => '',
		'priority'	   => '30',
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Two', 'bosa-ev-charging-station' ),
		'type'         => 'image',
		'settings'     => 'blog_highlights_two',
		'section'      => 'blog_highlights',
		'default'      => '',
		'priority'	   => '40',
		'choices'     => array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Caption Two', 'bosa-ev-charging-station' ),
		'type'        => 'text',
		'settings'    => 'highlights_caption_two',
		'section'     => 'blog_highlights',
		'default'     => '',
		'priority'	   => '50',
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Image Three', 'bosa-ev-charging-station' ),
		'type'         => 'image',
		'settings'     => 'blog_highlights_three',
		'section'      => 'blog_highlights',
		'default'      => '',
		'priority'	   => '60',
		'choices'     => array(
	...
	Kirki::add_field( 'bosa', array(
		'label'       => esc_html__( 'Caption Three', 'bosa-ev-charging-station' ),
		'type'        => 'text',
		'settings'    => 'highlights_caption_three',
		'section'     => 'blog_highlights',
		'default'     => '',
		'priority'	   => '70',
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable  Highlights', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_mobile_highlights',
		'section'      => 'blog_page_responsive',
		'default'      => false,
		'priority'	   => 26,
		'active_callback' => array(
			array(
				'setting'  => 'disable_highlights_section',
				'operator' => '==',
				'value'    => false,
			),
		),
	...
	//Advertisement
	Kirki::add_section( 'blog_advertisement', array(
	    'title'          => esc_html__( 'Advertisement', 'bosa-ev-charging-station' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 28,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Advertisement Section', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_advertisement_section',
		'section'      => 'blog_advertisement',
		'default'      => true,
		'priority'	   => '10',
	) );

	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement 1', 'bosa-ev-charging-station' ),
		'type'         => 'image',
		'settings'     => 'blog_advertisement_one',
		'section'      => 'blog_advertisement',
		'default'      => '',
		'priority'	   => '20',
		'choices'     => array(
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement 2', 'bosa-ev-charging-station' ),
		'type'         => 'image',
		'settings'     => 'blog_advertisement_two',
		'section'      => 'blog_advertisement',
		'default'      => '',
		'priority'	   => '30',
		'choices'     => array(
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Advertisement 3', 'bosa-ev-charging-station' ),
		'type'         => 'image',
		'settings'     => 'blog_advertisement_three',
		'section'      => 'blog_advertisement',
		'default'      => '',
		'priority'	   => '40',
		'choices'     => array(
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Advertisement', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_mobile_advertisement',
		'section'      => 'blog_page_responsive',
		'default'      => false,
		'priority'	   => 27,
		'active_callback' => array(
			array(
				'setting'  => 'disable_advertisement_section',
				'operator' => '==',
				'value'    => false,
			),
		),
	...
	#Members
	Kirki::add_section( 'blog_members', array(
	    'title'          => esc_html__( 'Members', 'bosa-ev-charging-station' ),
	    'panel'          => 'blog_homepage_options',
	    'capability'     => 'edit_theme_options',
	    'priority'       => 29,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Members Section', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_members_section',
		'section'      => 'blog_members',
		'default'      => true,
		'priority'	   => 10,
	) );
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Disable Members', 'bosa-ev-charging-station' ),
		'type'         => 'checkbox',
		'settings'     => 'disable_mobile_members',
		'section'      => 'blog_page_responsive',
		'default'      => false,
		'priority'	   => 29,
		'active_callback' => array(
			array(
				'setting'  => 'disable_members_section',
				'operator' => '==',
				'value'    => false,
			),
		),
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Product Title Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Product Price Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
	...
	Kirki::add_field( 'bosa', array(
		'label'        => esc_html__( 'Add to Cart Button Typography', 'bosa-ev-charging-station' ),
		'type'         => 'typography',
