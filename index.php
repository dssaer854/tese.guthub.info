...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_ev_charging_station_blog_advertisement_banner(); ?>
			...
			<!--Highlights-->
			<?php get_template_part( 'template-parts/highlights/highlights' ); ?>

			<!--Blog Advertisement-->
			<?php get_template_part( 'template-parts/advertisement/advertisement' ); ?>

			<!--Blog Teams-->
			<?php get_template_part( 'template-parts/members/members' ); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-ev-charging-station' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-ev-charging-station' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-ev-charging-station' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-ev-charging-station' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-ev-charging-station' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
