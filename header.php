...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'bosa-ev-charging-station' ); ?></a>

	<?php if( get_theme_mod( 'header_layout', 'header_thirteen' ) == '' || get_theme_mod( 'header_layout', 'header_thirteen' ) == 'header_one' ){
		get_template_part( 'template-parts/header/header', 'one' );
	}elseif( get_theme_mod( 'header_layout', 'header_thirteen' ) == 'header_two' ){
		get_template_part( 'template-parts/header/header', 'two' );
	}elseif( get_theme_mod( 'header_layout', 'header_thirteen' ) == 'header_three' ) {
		get_template_part( 'template-parts/header/header', 'three' );
	}elseif( get_theme_mod( 'header_layout', 'header_thirteen' ) == 'header_fifteen' ) {
		get_template_part( 'template-parts/header/header', 'fifteen' );
	}elseif( get_theme_mod( 'header_layout', 'header_thirteen' ) == 'header_thirteen' ) {
		get_template_part( 'template-parts/header/header', 'thirteen' );
	} ?>